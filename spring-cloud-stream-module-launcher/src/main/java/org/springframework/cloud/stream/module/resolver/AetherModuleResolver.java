...
public class AetherModuleResolver implements ModuleResolver {
		...
		if (isProxyEnabled()) {
			this.authentication = new Authentication() {
				...
				public void fill(AuthenticationContext context, String key, Map<String, String> data) {
					if (proxyProperties != null && StringUtils.hasText(proxyProperties.getUsername())) {
						context.put(context.USERNAME, proxyProperties.getUsername());
					}
					if (proxyProperties != null && StringUtils.hasText(proxyProperties.getPassword())) {
				...
				public void digest(AuthenticationDigest digest) {
					...
					if (proxyProperties != null && StringUtils.hasText(proxyProperties.getPassword())) {
						digest.update(AuthenticationContext.PASSWORD, proxyProperties.getPassword());
					}
				}
			};
		}
	...
	private boolean isProxyEnabled() {
		return (this.proxyProperties != null && this.proxyProperties.getHost() != null && proxyProperties.getPort() != null &&
				this.proxyProperties.getUsername() != null && this.proxyProperties.getPassword() != null);
	}
